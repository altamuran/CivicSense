      ...
      <div class="container">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
          ...
          <script>
            var customLabel = {
                Alta: {
                  label: 'https://civicsensesst.altervista.org/assets/img/m-rosso.png'
                },
                Media: {
                  label: 'https://civicsensesst.altervista.org/assets/img/m-arancione.png'
                },
                Bassa: {
                  label: 'https://civicsensesst.altervista.org/assets/img/m-verde.png'
                }
              };
