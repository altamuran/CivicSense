        ...
        <div class="form-row justify-content-center">
          ...
          <div class="form-row justify-content-center">
            <div class="col-sm-4 col-lg-6">
              <button class="btn btn-danger btn-block" data-toggle="modal" data-target="#ModalIrrisolto" <?php if ($stato!="Preso in carico"){echo disabled;} ?> onclick="estrapola_report()">Ticket Non Risolto ⛔</button>
            </div>
            <div class="col-sm-4 col-lg-6">
              <button class="btn btn-success btn-block" data-toggle="modal" data-target="#ModalRisolto" <?php if ($stato!="Preso in carico"){echo disabled;} ?>>Ticket Risolto ✅</button>
            </div>
        </div>
